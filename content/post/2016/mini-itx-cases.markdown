...
<p><img src="https://rubenerd.com/files/2016/miniitx_aerocool.png" srcset="https://rubenerd.com/files/2016/miniitx_aerocool.png 1x, https://rubenerd.com/files/2016/miniitx_aerocool.png@2x.png 2x" alt="" style="width:465px" /></p>
...
<p><img src="https://rubenerd.com/files/2016/miniitx_prodigy.png" srcset="https://rubenerd.com/files/2016/miniitx_prodigy.png 1x, https://rubenerd.com/files/2016/miniitx_prodigy.png@2x.png 2x" alt="" style="width:465px" /></p>
...
<p><img src="https://rubenerd.com/files/2016/miniitx_phenom.png" srcset="https://rubenerd.com/files/2016/miniitx_phenom.png 1x, https://rubenerd.com/files/2016/miniitx_phenom@2x.png 2x" alt="" style="width:465px" /></p>

The [Phenom] seems to be a further refinement to BitFenix's Mini-ITX cases. Gone are the superfluous handles, border accents and optical drive slot. It also only comes in black and white, but is billed as having "soft touch" panels ala the AeroCool DS-Cube.

Like the Cube, the case also features air intakes running along the edges, though not quite as clever. Curiously, it still has a 5.25 inch drive bay, but without a slot to access it. It also sports a drive cage that can be removed for longer width cards.

I love the design. It's understated and clean, a rarity among case manufacturers. A white Phenom would go great with my beautiful ASUS Turbo-OC GTX 970. It's also on the larger size though, which I'm trying to avoid.
...
[This crowd-funded case] is very impressive. Billed as the "smallest ITX gaming case in the world with the ability to mount full-size graphics cards", I can't think how they could shrink it any further. It's a work of art.

The space saving is achieved by mounting the graphics card against the back of the motherboard with 3M riser cables. I theorised such a setup back when I was thinking of building a Lego case, but wasn't sure about cooling.
...
It's a few litres larger than the Dan, but significantly smaller than most Mini-ITX cases. It still has plenty of internal expansion though, with tool-less mounting holes for a spinning drive or several SSDs. You can even order one with a top slit for a slim-line optical drive. 
...
I have a chronic issue with making electronic decisions of any kind, but this may be the case I go with.
